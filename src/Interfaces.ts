...
export interface IEntityNameMetaWithWidgetId
  extends IEntityNameMeta,
    IWidgetId {}

export interface IEntityFieldsMetaWithWidgetId
  extends IEntityFieldsMeta,
    IWidgetId {}

export interface IEntityFieldMetaWithWidgetId
  extends IEntityFieldMeta,
    IWidgetId {}
