...
export class GeneratorModal extends Component<IGeneratorModalProps, IGeneratorModalState> {
	state = {type: 0, code: ''}
	...
	render() {
		return (
			<Fragment>
				<Selector label="Type" value={this.state.type} onChange={this.handleChangeType.bind(this)} options={types} />
				<Textarea label="Code" text={this.state.code} onChange={() => {}} height={410} />
			</Fragment>
		)
	}
}
