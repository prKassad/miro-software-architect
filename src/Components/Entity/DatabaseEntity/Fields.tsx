...
export class DatabaseEntityFieldsContainer extends Component<
  IDatabaseEntityFieldsContainerProps,
  {}
> {
  render() {
    return (
        ...
        {this.props.fieldContainers.map((field, index) => (
          <div key={index}>
            ...
            <DatabaseEntityField
              field={field}
              index={index}
              setField={(field: IEntityFieldMetaWithWidgetId) =>
                this.props.onFieldUpdated(index, field)
              }
            ></DatabaseEntityField>
            <Button
              type={ButtonType.SECONDARY}
              onClick={e => this.props.onFieldRemoved(index)}
              textColor="#e01616"
            >
              Remove field
            </Button>
